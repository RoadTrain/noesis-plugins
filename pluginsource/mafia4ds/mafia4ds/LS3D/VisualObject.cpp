...
////
//-- Visual Object (including SINGLEMESH/SINGLEMORPH/MORPH) methods
////
void VisualObject::read(RichBitStream *bs)
{
...
void VisualObject::render(noeRAPI_t *rapi)
{
